function problem2Spat()
clear variables
% Declare the amount of Spheres (N)
TM=zeros(15,1); % creating space for terminal velocity
Nstep=3:2:31;
for p=3:2:31
    N=p;
    ...
    %}
    m=(N+1)/2;
    fprintf('Terminal Velocity of %d nodes = %f meters/sec\n',p, u(2*m))
...
title('Terminal Velocity at Varying Spacial Discretization')
